                ...
                <div class="testimonial-carousel owl-carousel">
                    <div class="item">
                        ...
                        <div class="description">
                            <p>
                                I've been a supporter of this charity for many years and have seen the incredible impact they have on the lives of those in need. They provide essential services to vulnerable populations and work to make a difference in the world. 
                            </p>
                        </div>
                    </div>
                    <div class="item">
                    ...
                    <div class="item">
                        <div class="photo">
                            <img src="uploads/t3.jpg" alt="" />
                        </div>
                        <div class="text">
                            <h4>Peter Smith</h4>
                            <p>Director, RTT Company</p>
                        </div>
                        <div class="description">
                            <p>
                                I've been a supporter of this charity for many years and have seen the incredible impact they have on the lives of those in need. They provide essential services to vulnerable populations and work to make a difference in the world.
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                <div class="item pb_70">
                    <div class="photo">
                        <img src="uploads/post-1.jpg" alt="" />
                    </div>
                    <div class="text">
                        <h2>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                <div class="item pb_70">
                    <div class="photo">
                        <img src="uploads/post-2.jpg" alt="" />
                    </div>
                    <div class="text">
                        <h2>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                <div class="item pb_70">
                    <div class="photo">
                        <img src="uploads/post-3.jpg" alt="" />
                    </div>
                    <div class="text">
                        <h2>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                <div class="item pb_70">
                    <div class="photo">
                        <img src="uploads/post-4.jpg" alt="" />
                    </div>
                    <div class="text">
                        <h2>
